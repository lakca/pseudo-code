...
const styles=require("./inject.styl"),inject=require("./inject.js"),{parse:parse,generate:generate}=require("./parser.js"),{PSEUDO_CODE:PSEUDO_CODE,INJECT_FLAG:INJECT_FLAG}=require("./def"),parsers={};function pseudoCode(e,t={}){if(e.length){let e=document.head.querySelector(`style[${PSEUDO_CODE}]`);e||((e=document.createElement("style")).setAttribute(PSEUDO_CODE,"true"),document.head.appendChild(e)),e.innerHTML=styles}for(const t of e){const e=parse(t.innerText);t.innerHTML=generate(e);const r=Math.random();t[PSEUDO_CODE]=r,t.setAttribute(PSEUDO_CODE,r),parsers[r]=e}window[INJECT_FLAG]||(inject({parsers:parsers,options:t}),window[INJECT_FLAG]=!0)}"object"==typeof window?window.pseudoCode=pseudoCode:module.exports=pseudoCode;

},{"./def":2,"./inject.js":3,"./inject.styl":4,"./parser.js":5}],2:[function(require,module,exports){
const TOKEN={ESCAPE:"@",NEWLINE:"\n",DEF:"#",OR:"|",AND:"&",RAW:"'",RAW_END:"'",CODE:"`",CODE_END:"`",STRONG:"*",STRONG_END:"*",MARK:"/",MARK_END:"/",META:'"',META_END:'"',LINK:"[",LINK_END:"]",FUNC:"<",FUNC_END:">",FUNC_PARAM_SEP:",",SEP:" \t\n"},NODE={NEWLINE:"NEWLINE",DEF:"DEF",OR:"OR",AND:"AND",RAW:"RAW",RAW_INFER:"RAW_INFER",RAW_END:"RAW_END",CODE:"CODE",CODE_END:"CODE_END",STRONG:"STRONG",STRONG_END:"STRONG_END",MARK:"MARK",MARK_END:"MARK_END",META:"META",META_END:"META_END",LINK:"LINK",LINK_END:"LINK_END",FUNC:"FUNC",FUNC_NAME:"FUNC_NAME",FUNC_LEFT_EDGE:"FUNC_LEFT_EDGE",FUNC_PARAM:"FUNC_PARAM",FUNC_PARAM_END:"FUNC_PARAM_END",FUNC_PARAM_SEP:"FUNC_PARAM_SEP",FUNC_RIGHT_EDGE:"FUNC_RIGHT_EDGE",FUNC_END:"FUNC_END"},ENTITY_NODE_TOKEN={NEWLINE:!0,OR:!0,AND:!0,RAW_INFER:!0,FUNC:!0,FUNC_END:!0,FUNC_PARAM_SEP:!0},PSEUDO_CODE="_PSEUDO_CODE_",INJECT_FLAG="_INJECT_PSEUDO_CODE_";module.exports={TOKEN:TOKEN,NODE:NODE,ENTITY_NODE_TOKEN:ENTITY_NODE_TOKEN,PSEUDO_CODE:PSEUDO_CODE,INJECT_FLAG:INJECT_FLAG};

},{}],3:[function(require,module,exports){
const{NODE:NODE,PSEUDO_CODE:PSEUDO_CODE}=require("./def"),{generate:generate}=require("./parser");module.exports=function({parsers:t,options:e}){const s=document.createElement("div");document.body.appendChild(s),s.style.position="fixed",s.style.display="none",s.style.background="#f6f6f6",s.style.borderRadius="8px",s.style.boxShadow="0 0 10px #d6d6d6",Object.assign(s.style,e.popupStyles),document.body.addEventListener("mouseover",o=>{const r=o.target.classList.contains(NODE.LINK),n=o.target.classList.contains(NODE.DEF);if(r||n){for(const t of o.target.closest(".PSEUDO-CODE").querySelectorAll('[href="'+o.target.getAttribute("href")+'"]'))t.classList.add("hover");if(r){const r=e.local?o.target.closest(`[${PSEUDO_CODE}]`).querySelector(o.target.getAttribute("href")):document.body.querySelector(`[${PSEUDO_CODE}] ${o.target.getAttribute("href")}`);if(r){const e=r.closest(`[${PSEUDO_CODE}]`),n=e[PSEUDO_CODE]||e.getAttribute(PSEUDO_CODE);if(t[n]){const e=[];for(const s of t[n])if(s.t===NODE.DEF&&s.s===r.id)e.push(s);else if(e.length){if(s.t===NODE.DEF)break;e.push(s)}for(let t=e.length;t--&&(e[t].t===NODE.NEWLINE||e[t].t===NODE.RAW_INFER&&!e[t].s.trim());)e.length-=1;!function(t,e){const o=t.getBoundingClientRect();s.innerHTML=e,s.style.display="block",s.style.left=o.x+o.width+10+"px",s.style.top=o.y+"px"}(o.target,generate(e))}}}}}),document.body.addEventListener("mouseout",t=>{if(t.target.classList.contains(NODE.LINK)||t.target.classList.contains(NODE.DEF)){for(const e of t.target.closest(".PSEUDO-CODE").querySelectorAll('[href="'+t.target.getAttribute("href")+'"]'))e.classList.remove("hover");s.style.display="none"}})};
